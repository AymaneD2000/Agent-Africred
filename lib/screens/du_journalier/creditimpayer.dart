...
class CreditImpayerScreen extends StatefulWidget {
  const CreditImpayerScreen({super.key});

  @override
  State<CreditImpayerScreen> createState() => _CreditImpayerScreenState();
}

class _CreditImpayerScreenState extends State<CreditImpayerScreen> {
  int currentPage = 0;
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Mytext(
                  text: "Encours   Global   :   1 375 100 CFA",
                  color: Color(0xffff3d60),
